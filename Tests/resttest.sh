...
curl -H "Content-Type: application/json" -d '{	"username": "suscipit.nonummy@necorcidonec.co.uk",	"password": "KLH24GVU5RE",	"f_name": "Hayfa",	"l_name": "Gray",	"age": 36}' -X POST http://localhost:8000/api/users
